...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Internship Customerbase'), ['action' => 'edit', $internshipCustomerbase->internship_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Internship Customerbase'), ['action' => 'delete', $internshipCustomerbase->internship_id], ['confirm' => __('Are you sure you want to delete # {0}?', $internshipCustomerbase->internship_id)]) ?> </li>
...
<div class="internshipCustomerbase view large-9 medium-8 columns content">
    <h3><?= h($internshipCustomerbase->internship_id) ?></h3>
