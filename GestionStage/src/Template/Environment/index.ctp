 ...
 * @var \App\Model\Entity\Environment[]|\Cake\Collection\CollectionInterface $environment
 */
?>
...
<div class="environment index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($environment as $environment): ?>
            <tr>
