...
return [
     ...
     */    
	 'EmailTransport' => [
        'tinstageTransport' => [
             ...
             */
            'host' => 'mail.tinstage.ca',
            'port' => 25,
            'timeout' => 30,
            'username' => 'contact@tinstage.ca',
            'password' => '.-4@"(!{}r9>aUq&._{UsxGcDYG$NX8?2^*xkqJ}]@,\'}Uz+',
            'client' => null,
            'tls' => null,
    ...
    'Email' => [
        'tinstage' => [
            'transport' => 'tinstageTransport',
            'from' => 'contact@tinstage.ca',
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'username' => 'tinstage_admin',
            'password' => 'Ibjs5mjaux_123',
